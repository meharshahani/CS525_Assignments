...
*FILE MANIPULATION*(Executed by:Disha Patel(A20452866))
...
*READING BLOCKS FROM DISK* (Executed by:Mehar Shahani(A20439871))
...
*WRITEING BLOCKS FROM DISK*(Executed by:Yash Raj(A20453633))
